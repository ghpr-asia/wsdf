...
impl<'tvb, T> Dissect<'_, ()> for Vec<T>
where
    T: Dissect<'tvb, ()>,
{
    type Emit = ();
...
impl<'tvb, T> Dissect<'_, [u8]> for Vec<T>
where
    T: Dissect<'tvb, [u8]>,
{
    type Emit = ();
...
impl<'tvb, T, const N: usize> Dissect<'_, ()> for [T; N]
where
    T: Dissect<'tvb, ()>,
{
    type Emit = ();
...
impl<'tvb, T, const N: usize> Dissect<'_, [u8]> for [T; N]
where
    T: Dissect<'tvb, [u8]>,
{
    type Emit = ();
